function Header() {
    return <>
        <div className="my-3 bg-gradient-to-r from-[#0052CC] via-[#5FD4AF] to-[#0052CC] text-center p-4 font-body text-white">درس خوندن به راهه | بسته های آموزشی با بهترین قیمت</div>
